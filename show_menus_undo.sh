...
show_submenu_undo_del_old_files(){
    NORMAL=`echo "\033[m"`
    MENU=`echo "\033[36m"` #Blue
    NUMBER=`echo "\033[33m"` #yellow
    FGRED=`echo "\033[41m"`
...
show_submenu_undo_del_large_files(){
    NORMAL=`echo "\033[m"`
    MENU=`echo "\033[36m"` #Blue
    NUMBER=`echo "\033[33m"` #yellow
    FGRED=`echo "\033[41m"`
...
show_submenu_undo_lang(){
    ...
    ENTER_LINE=`echo "\033[33m"`
    echo -e "${MENU}*********************************************${NORMAL}"
    echo -e "${MENU}**${NUMBER}   1)${MENU} Choose languages to keep ${NORMAL}"
    echo -e "${MENU}**${NUMBER}   2)${MENU} Choose languages to delete ${NORMAL}"
    echo -e "${MENU}**${NUMBER} 100)${MENU} Return to menu ${NORMAL}"
    echo -e "${MENU}*********************************************${NORMAL}"
    echo -e "${ENTER_LINE}Please enter a menu option and enter. ${NORMAL}"
    read opt
